"""Register CaP-X tool APIs.

Most simulator-specific APIs pull optional robotics dependencies at import
time. Keep lightweight APIs registered first so environments such as UniVTAC
can use CaP-X without installing unrelated Robosuite/Franka perception stacks.
"""
...
if os.getenv("CAPX_UNIVTAC_MINIMAL_IMPORTS", "0") != "1":
    try:
        ...
        print("Tactile proxy APIs not installed, skipping TactileMemoryApi")
    ...
    try:
        ...
        print("Franka APIs not installed, skipping Franka API registrations")
        register_api("FrankaControlApi", UniVTACFrankaCompatApi)
